									 	...
									 	<div class="row">
											...
											<div class="col-xxs-12 col-xs-6 mt">
												...
												<label for="from">To:</label>
													<select name="d" class="form-control select2 f14Bold" id="cbo_to">
														<option value=""></option>
														<?php
															foreach ($airports as $airport){
																if ($airport->country_id != 'id') {
										...
										<div class="col-xxs-12 mt alternate no-padding">
											...
											<div class="col-xs-6 mt alternate">
												<div class="input-field">
													<label for="date-start" class="lableFont">BERANGKAT:</label>
													<div class="input-group">
								                      <input type="text" class="form-control"  id="date-start" placeholder="mm/dd/yyyy" value="<?php echo (strcmp($s_date, '')==0) ? date('Y-m-d', strtotime('+30 days')) : $s_date; ?>"/>
								                      <div class="input-group-addon">
								                        <i class="icon-calendar"></i>
								                      </div>
								                    </div>
											...
											<div class="col-xs-6 mt alternate">
												<div class="input-field">
													...
													<div class="input-group">
								                      <input type="text" class="form-control" id="date-end" placeholder="mm/dd/yyyy"/ value="<?php echo date("d-m-Y"); ?>">
								                      <div class="input-group-addon">
								                        <i class="icon-calendar"></i>
								                      </div>
								                    </div>
