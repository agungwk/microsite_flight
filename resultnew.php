...
font-family: "Montserrat", Montserrat, Arial, sans-serif; -->
	...
	<body  style="background-color: #7798c5;">
		...
		<div class="">
			...
			<div class="row filterBox no-margin">
				<div class="col-xs-4"><button class="btnBlank" data-toggle="collapse" >MASKAPAI</button></div>
				<div class="col-xs-4"><button class="btnBlank" data-toggle="collapse" >WAKTU</button></div>
				<div class="col-xs-4"><button class="btnBlank" data-toggle="collapse" >TRANSIT</button></div>
			</div>
